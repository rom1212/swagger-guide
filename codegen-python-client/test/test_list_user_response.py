...
from swagger_client.models.list_user_response import ListUserResponse  # noqa: E501
...
class TestListUserResponse(unittest.TestCase):
    ...
    def testListUserResponse(self):
        ...
        # model = swagger_client.models.list_user_response.ListUserResponse()  # noqa: E501
        pass
