...
import io.swagger.client.model.ListUserResponse;
...
public class UserApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listUsersCall(String pageToken, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listUsersValidateBeforeCall(String pageToken, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = listUsersCall(pageToken, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListUserResponse listUsers(String pageToken, Integer pageSize) throws ApiException {
        ApiResponse<ListUserResponse> resp = listUsersWithHttpInfo(pageToken, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListUserResponse> listUsersWithHttpInfo(String pageToken, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = listUsersValidateBeforeCall(pageToken, pageSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listUsersAsync(String pageToken, Integer pageSize, final ApiCallback<ListUserResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listUsersValidateBeforeCall(pageToken, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListUserResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
